...
const Loader = () => {
  ...
  return (
    ...
    <div role="status flex">
        <p>Loading... </p>
        <svg aria-hidden="true" class="w-4  h-4 text-gray-600 animate-spin dark:text-gray-600 fill-blue-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
